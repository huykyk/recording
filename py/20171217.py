...
#        print(word+'/'+ ntag)
        if(ntag == "B-Ni" or ntag == "I-Ni" or ntag=="E-Ni"):
           ntag_list.append(word) 
...
to_company_trans = []        #股转发生公司2名称

percent_trans = []       #股转发生比例
amount_trans = []       #股转发生金额


f = codecs.open('D:\input1.txt','r+',encoding='utf-8')
str = f.read()
...
#print(date_meeting)    
#for item in ntag_list:
#    print(ntag_list)
print(''.join(ntag_list))
